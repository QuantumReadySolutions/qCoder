...
from qcoder.blueprint_decisions_public_oss import profile_decision_catalog_snapshot
...
def algorithm_blueprint_contract_snapshot() -> dict[str, Any]:
    from qcoder.context_loop_public_oss import context_loop_contract_snapshot
