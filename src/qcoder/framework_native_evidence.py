...
def framework_native_contract_snapshot() -> dict[str, Any]:
    payload = {
        "schema_id": "qcoder.framework_native.evidence_contract.v1",
        "schema_version": 1,
        "bounded_frameworks": ["pennylane"],
        "explicit_circuit_manifest_required": True,
        "strict_result_manifest_required": True,
        "qasm_required": False,
        "qasm_conversion_performed": False,
        "semantic_equivalence_to_qasm_claimed": False,
        "native_execution_owned_by_qcoder": False,
        "universal_framework_support_claimed": False,
    }
...
__all__ = [
    "FRAMEWORK_MANIFEST_SCHEMA_ID",
    "FrameworkNativeEvidenceError",
    "framework_native_contract_snapshot",
