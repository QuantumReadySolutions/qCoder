...
from qcoder.context_loop_public_oss import CONTEXT_LOOP_GATE
...
class CurrentLoopCoordinator:
    ...
    def prepare_connected_assistant_blueprint(
        ...
        *,
        ...
        from qcoder.d079_workflows_public_oss import prepare_ide_first_blueprint
    ...
    def confirm_connected_assistant_blueprint(
        ...
        *,
        ...
        from qcoder.d079_workflows_public_oss import (
    ...
    def revise_connected_assistant_blueprint(
        ...
        *,
        ...
        from qcoder.d079_workflows_public_oss import revise_ide_first_blueprint
    ...
    def review_customer_selected_files(
        ...
        *,
        ...
        from qcoder.d079_workflows_public_oss import D079WorkflowError, review_selected_files_with_qcoder
    ...
    def _decision_records(self, blueprint: Mapping[str, Any]) -> list[dict[str, Any]]:
        from qcoder.blueprint_decisions_public_oss import unpack_decision_record_set
