...
`src/qcoder/model_packs/wi0440_review_before_generation_class_matrix_v1.json`. Deterministic Bell
goldens are under `tests/fixtures/wi0440_review_before_generation_v1/goldens/`.
