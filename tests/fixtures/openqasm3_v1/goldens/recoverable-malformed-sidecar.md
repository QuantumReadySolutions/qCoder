...
- Selected artifact: `recoverable_malformed.qasm3`
- Source SHA-256: `7c213da42fe17e4e666aa2960bfb300cfd7886c769736d9129074022cd8a2409`
...
- `construct-0002` qubit_declaration `qubit`: `malformed`
- `construct-0003` qubit_declaration `q`: `supported`
- `construct-0004` quantum_operation `h`: `supported`

## Derived facts

- quantum_width: `1` — `partial`
- classical_width: `0` — `partial`
- operation_count: `1` — `lower_bound`
- measurement_count: `0` — `lower_bound`
- depth: `null` — `not_established`
- interaction_graph: `[]` — `not_established`
- gate_statistics: `{"h": 1}` — `partial`
